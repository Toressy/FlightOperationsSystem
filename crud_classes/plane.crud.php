...
class planeCrud 
{
	...
	public function createStaff($EMPNUM, $SURNAME, $NAME, $DATEOFBIRTH)
	{
		$existing = $this->getStaffID($EMPNUM);
	...
	public function createPilot($EMPNUM, $SURNAME, $NAME, $DATEOFBIRTH, $TOTALFLIGHTHOURS)
	{
		$existing = $this->getStaffID($EMPNUM);
		...
		$stmt1 = $this->db->prepare("INSERT INTO STAFF (EMPNUM, SURNAME, NAME, DATEOFBIRTH) 
		VALUES(?, ?, ?, ?)");
		$stmt1->bind_param("isss", $EMPNUM, $SURNAME, $NAME, $DATEOFBIRTH);

		$stmt1->execute();
		$stmt1->close();
		$stmt2 = $this->db->prepare("INSERT INTO PILOT (EMPNUM, TOTALFLIGHTHOURS)
		VALUES(?, ?)");
		$stmt2->bind_param("ii", $EMPNUM, $TOTALFLIGHTHOURS);
	...
	public function getStaffID($EMPNUM)
	{
